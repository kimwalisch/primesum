...
const Array<int, 7> PhiTiny::primes = { 0, 2, 3, 5, 7, 11, 13 };

// prime_products[n] = \prod_{i=1}^{n} primes[i]
const Array<int, 7> PhiTiny::prime_products = { 1, 2, 6, 30, 210, 2310, 30030 };

// totients[n] = \prod_{i=1}^{n} (primes[i] - 1)
const Array<int, 7> PhiTiny::totients = { 1, 1, 2, 8, 48, 480, 5760 };

// Number of primes below x
const Array<int, 13> PhiTiny::pi = { 0, 0, 1, 2, 2, 3, 3, 4, 4, 4, 4, 5, 5 };
